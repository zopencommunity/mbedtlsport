node('linux') {
  stage ('Poll') {
    checkout([
      ...
      userRemoteConfigs: [[url: 'https://github.com/zopencommunity/mbedtlsport.git']]])
  }
  stage('Build') {
    build job: 'Port-Pipeline', parameters: [
      string(name: 'PORT_GITHUB_REPO', value: 'https://github.com/zopencommunity/mbedtlsport.git'),
